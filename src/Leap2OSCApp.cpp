...
class Leap2OSCApp : public AppNative {
public:
...
// -------- SPOUT -------------
void Leap2OSCApp::prepareSettings(Settings *settings)
{
        g_Width  = 640;
        g_Height = 512;
...
void Leap2OSCApp::setup()
{
    // load an image to texture the demo cube with
    cubeTexture = loadImage( "../assets/reymenta.jpg" );
...
// -------- SPOUT -------------
void Leap2OSCApp::shutdown()
{
    spoutsender.ReleaseSender();
}
// This line tells Cinder to actually create the application
CINDER_APP_NATIVE( Leap2OSCApp, RendererGl )
